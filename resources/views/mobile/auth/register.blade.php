<x-layouts.mobile.default>
    ...
    <form x-data="register" dir="ltr" action="{{ route('postRegister') }}" method="post" class="my-4">
        @csrf
...
{{--            </div>--}}
            ...
            <button class="text-white bg-primary mt-4 h-12 px-2 rounded-md w-full" type="submit">{{ __('general.register') }}</button>
        </div>
    </form>
