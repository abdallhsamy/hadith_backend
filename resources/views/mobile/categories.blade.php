...
{{--                                                    </div>--}}
                            ...
                            <div class="flex gap-1">{{ $item->hadeeths_count }}<i class="mdi mdi-newspaper-variant-outline"></i></div>
                        </div>
                        <div class="flex gap-1"><i class="mdi mdi-eye"></i> {{ $item->hadeeths_count }}</div>
                    </div>
                </a>
            ...
            <div>
                <a href="#" class="flex w-full transform transition-all duration-300 scale-100 hover:scale-95">
                    ...
                    <div class="ps-3 w-3/5">
                        <div class="text-xs text-gray-500 uppercase font-semibold flex gap-1 @if($item->hadeeths_count > 0) mb-2 @endif">
{{--                            @foreach($item->categoriesRel as $cat)--}}
