<x-layouts.dashboard.default>
    ...
    <div class="panel">
        ...
        <table class="min-w-full divide-y divide-shade dark:divide-shade">
            ...
            <th scope="col"
                class="px-6 py-2 text-start text-xs font-medium text-gray-500 uppercase">{{ __('general.title') }}</th>
            <th scope="col"
                class="px-6 py-2 text-start text-xs font-medium text-gray-500 uppercase">{{ __('general.hadiths_count') }}</th>
            <th scope="col"
