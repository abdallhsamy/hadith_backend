<x-layouts.dashboard.default>
    ...
    <div class="flex items-center justify-between mb-8">
        <h1 class="text-lg font-medium truncate me-5">{{ __('general.language_list') }}</h1>
        <a href="{{ route('dashboard.languages.create') }}" class="bg-primary text-white py-2 px-4 rounded-md">
            {{ __('general.add_new_language') }}
        </a>
    </div>
    ...
    <div class="panel">
        ...
        <table class="min-w-full divide-y divide-shade dark:divide-shade">
            ...
            <th scope="col"
                class="px-6 py-2 text-start text-xs font-medium text-gray-500 uppercase">{{ __('general.code') }}</th>
            <th scope="col"
                class="px-6 py-2 text-start text-xs font-medium text-gray-500 uppercase">{{ __('general.name') }}</th>
            <th scope="col"
                class="px-6 py-2 text-end text-xs font-medium text-gray-500 uppercase">{{ __('general.actions') }}</th>
            </thead>
            <tbody>
